...
function App() { 
  ...
  return (
    <div className="App">
      ...
      label="Fixed/Free"
      />
      <SimpleSelect onChange={setSample} options={['Pandeiro','Snare','Repenique']}   /> 
      ...
      <div style={{marginTop:50}} >
        <p>Designed by <a target='_blank' rel="noopener noreferrer" href={'https://scottkettner.com'}>Scott Kettner</a> and <a target='_blank' rel="noopener noreferrer" href={'https://omrinuri.com'}  >Omri Nuri</a></p>
      </div>
      {/* <ShareDial/> */}
    </div>
  );
